...
function WriteDictionaryUE({ dictionary, selectCount }) {
                    ...
                    <div key="index" className="card-wrapper">
                        {isScore ? (
                            <div className="write-wrapper">
                                <h1 className="text-capitalize">{item.uzbek}</h1>
                                <input
                                ...
                                <button
                                    className="btn-write"
                                    onClick={() => nextClicked(item.english)}
                                >
                                    Keyingisi
                                </button>
                            </div>
...
export default WriteDictionaryUE;
